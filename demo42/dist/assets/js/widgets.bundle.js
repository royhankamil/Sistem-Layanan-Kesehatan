...
var KTChartsWidget22 = function () {
    var renderChart = function (containerId, chartElement, seriesData, labels, renderImmediately) {
        var chartContainer = document.querySelector(chartElement);
        if (chartContainer) {
            var options = {
                series: seriesData,
                chart: {
                ...
                colors: [KTUtil.getCssVariableValue("--bs-info"), KTUtil.getCssVariableValue("--bs-danger"), KTUtil.getCssVariableValue("--bs-warning"), KTUtil.getCssVariableValue("--bs-success"), KTUtil.getCssVariableValue("--bs-primary")],
                stroke: {
                    width: 0,
                },
                labels: labels,
            ...
            var tabTrigger = document.querySelector(containerId);
    ...
    return {
        init: function () {
            renderChart("#tab_statistik_pasien", "#statistik_pasien_jenis_kelamin", [293, 300], ["Laki-laki", "Perempuan"], true);

            renderChart(
                "#tab_statistik_pasien", 
                "#statistik_pasien_usia", 
                [40, 50, 70, 350, 83], 
                ["<5", "5-9", "10-18", "19-59", "60+"], 
                true
            );
        },
    };
